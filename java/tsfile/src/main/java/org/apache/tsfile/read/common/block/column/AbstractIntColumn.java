...
public abstract class AbstractIntColumn implements Column {

  protected static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(AbstractIntColumn.class);
  ...
  public AbstractIntColumn(int initialCapacity) {
    this(0, 0, null, new int[initialCapacity]);
  }

  public AbstractIntColumn(int positionCount, Optional<boolean[]> valueIsNull, int[] values) {
    this(0, positionCount, valueIsNull.orElse(null), values);
  }

  AbstractIntColumn(int arrayOffset, int positionCount, boolean[] valueIsNull, int[] values) {
    if (arrayOffset < 0) {
  ...
  protected abstract AbstractIntColumn instance(
