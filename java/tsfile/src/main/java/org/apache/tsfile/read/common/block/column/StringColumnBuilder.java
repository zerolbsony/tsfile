...
public class StringColumnBuilder implements ColumnBuilder {
  ...
  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(StringColumnBuilder.class);

  private final ColumnBuilderStatus columnBuilderStatus;
  public static final StringColumn NULL_VALUE_BLOCK =
      new StringColumn(0, 1, new boolean[] {true}, new Binary[1]);
  ...
  public StringColumnBuilder(ColumnBuilderStatus columnBuilderStatus, int expectedEntries) {
  ...
  public ColumnBuilder writeBinary(Binary value) {
    ...
    if (columnBuilderStatus != null) {
      columnBuilderStatus.addBytes(
          StringColumn.SHALLOW_SIZE_IN_BYTES_PER_POSITION
  ...
  public ColumnBuilder writeObject(Object value) {
    ...
    throw new UnSupportedDataTypeException("StringColumn only support Binary data type");
  }
  ...
  public ColumnBuilder appendNull() {
    ...
    positionCount++;
    if (columnBuilderStatus != null) {
      columnBuilderStatus.addBytes(StringColumn.SHALLOW_SIZE_IN_BYTES_PER_POSITION);
    }
    return this;
  }
  ...
  public ColumnBuilder newColumnBuilderLike(ColumnBuilderStatus columnBuilderStatus) {
    return new StringColumnBuilder(columnBuilderStatus, calculateBlockResetSize(positionCount));
  }
