...
public class TimestampColumnBuilder implements ColumnBuilder {
  ...
  private static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(TimestampColumnBuilder.class);
  public static final TimestampColumn NULL_VALUE_BLOCK =
      new TimestampColumn(0, 1, new boolean[] {true}, new long[1]);
  ...
  public TimestampColumnBuilder(ColumnBuilderStatus columnBuilderStatus, int expectedEntries) {
  ...
  public ColumnBuilder writeLong(long value) {
    ...
    if (columnBuilderStatus != null) {
      columnBuilderStatus.addBytes(TimestampColumn.SIZE_IN_BYTES_PER_POSITION);
    }
    return this;
  }
  ...
  public ColumnBuilder writeObject(Object value) {
    ...
    throw new UnSupportedDataTypeException("TimestampColumn only support Long data type");
  }
  ...
  public Column build() {
    ...
    return new TimestampColumn(0, positionCount, hasNullValue ? valueIsNull : null, values);
  }
  ...
  public ColumnBuilder newColumnBuilderLike(ColumnBuilderStatus columnBuilderStatus) {
    return new TimestampColumnBuilder(columnBuilderStatus, calculateBlockResetSize(positionCount));
  }
