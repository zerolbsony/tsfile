...
public class DateColumn implements Column {
  ...
  private static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(DateColumn.class);
  ...
  public Column getRegion(int positionOffset, int length) {
    ...
    return new DateColumn(positionOffset + arrayOffset, length, valueIsNull, values);
  }
  ...
  public Column getRegionCopy(int positionOffset, int length) {
    ...
    return new DateColumn(0, length, valueIsNullCopy, valuesCopy);
  }
  ...
  public Column subColumn(int fromIndex) {
    ...
    return new DateColumn(arrayOffset + fromIndex, positionCount - fromIndex, valueIsNull, values);
  }
  ...
  public Column copyPositions(int[] positions, int offset, int length) {
    ...
    return new DateColumn(0, length, newValueIsNull, newValues);
  }
