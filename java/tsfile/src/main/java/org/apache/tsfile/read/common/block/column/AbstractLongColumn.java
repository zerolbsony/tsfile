...
public abstract class AbstractLongColumn implements Column {

  protected static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(AbstractLongColumn.class);
  ...
  public AbstractLongColumn(int initialCapacity) {
    this(0, 0, null, new long[initialCapacity]);
  }

  public AbstractLongColumn(int positionCount, Optional<boolean[]> valueIsNull, long[] values) {
    this(0, positionCount, valueIsNull.orElse(null), values);
  }

  AbstractLongColumn(int arrayOffset, int positionCount, boolean[] valueIsNull, long[] values) {
    if (arrayOffset < 0) {
  ...
  public Column getRegion(int positionOffset, int length) {
    ...
    return instance(positionOffset + arrayOffset, length, valueIsNull, values);
  }
  ...
  public Column getRegionCopy(int positionOffset, int length) {
    ...
    return instance(0, length, valueIsNullCopy, valuesCopy);
  }
  ...
  public Column subColumn(int fromIndex) {
    ...
    return instance(arrayOffset + fromIndex, positionCount - fromIndex, valueIsNull, values);
  }
  ...
  public Column copyPositions(int[] positions, int offset, int length) {
    ...
    return instance(0, length, newValueIsNull, newValues);
  }
  ...
  protected abstract AbstractLongColumn instance(
      int arrayOffset, int positionCount, boolean[] valueIsNull, long[] values);
}
