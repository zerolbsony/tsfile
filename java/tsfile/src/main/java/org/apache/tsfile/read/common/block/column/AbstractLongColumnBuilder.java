...
public abstract class AbstractLongColumnBuilder implements ColumnBuilder {

  protected static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(AbstractLongColumnBuilder.class);
  ...
  public AbstractLongColumnBuilder(ColumnBuilderStatus columnBuilderStatus, int expectedEntries) {
  ...
  public Column build() {
    ...
    if (getDataType() == TSDataType.INT64) {
  ...
  protected abstract AbstractLongColumnBuilder instance(
