...
public class StringColumn implements Column {
  ...
  private static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(StringColumn.class);
  ...
  public Column getRegionCopy(int positionOffset, int length) {
    ...
    return new StringColumn(0, length, valueIsNullCopy, valuesCopy);
  }
  ...
  public Column copyPositions(int[] positions, int offset, int length) {
    ...
    return new StringColumn(0, length, newValueIsNull, newValues);
  }
