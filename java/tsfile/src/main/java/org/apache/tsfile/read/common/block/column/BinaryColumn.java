...
public class BinaryColumn extends AbstractBinaryColumn {
  ...
  public AbstractBinaryColumn instance(
    ...
    return new BinaryColumn(arrayOffset, positionCount, valueIsNull, values);
  }
  ...
  public AbstractBinaryColumn instance(
      ...
      Binary[] values,
      long retainedSizeInBytes) {
    return new BinaryColumn(arrayOffset, positionCount, valueIsNull, values, retainedSizeInBytes);
  }
}
