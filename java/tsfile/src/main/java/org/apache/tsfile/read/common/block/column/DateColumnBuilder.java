...
public class DateColumnBuilder implements ColumnBuilder {
  ...
  private static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(DateColumnBuilder.class);
  public static final DateColumn NULL_VALUE_BLOCK =
      new DateColumn(0, 1, new boolean[] {true}, new int[1]);
  ...
  public DateColumnBuilder(ColumnBuilderStatus columnBuilderStatus, int expectedEntries) {
  ...
  public ColumnBuilder writeInt(int value) {
    ...
    if (columnBuilderStatus != null) {
      columnBuilderStatus.addBytes(DateColumn.SIZE_IN_BYTES_PER_POSITION);
    }
    return this;
  }
  ...
  public ColumnBuilder newColumnBuilderLike(ColumnBuilderStatus columnBuilderStatus) {
    return new DateColumnBuilder(columnBuilderStatus, calculateBlockResetSize(positionCount));
  }
