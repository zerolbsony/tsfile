...
public abstract class AbstractBinaryColumn implements Column {

  protected static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(AbstractBinaryColumn.class);
  ...
  protected final Binary[] values;

  protected final long retainedSizeInBytes;
  protected final long sizeInBytes;

  public AbstractBinaryColumn(int initialCapacity) {
    this(0, 0, null, new Binary[initialCapacity]);
  }

  public AbstractBinaryColumn(int positionCount, Optional<boolean[]> valueIsNull, Binary[] values) {
    this(0, positionCount, valueIsNull.orElse(null), values);
  }

  AbstractBinaryColumn(int arrayOffset, int positionCount, boolean[] valueIsNull, Binary[] values) {
    if (arrayOffset < 0) {
  ...
  protected AbstractBinaryColumn(
      int arrayOffset,
      int positionCount,
      boolean[] valueIsNull,
      Binary[] values,
  ...
  public abstract AbstractBinaryColumn instance(
