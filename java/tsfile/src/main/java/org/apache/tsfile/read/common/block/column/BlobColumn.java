...
public class BlobColumn extends AbstractBinaryColumn {
  ...
  public AbstractBinaryColumn instance(
    ...
    return new BlobColumn(arrayOffset, positionCount, valueIsNull, values);
  }
  ...
  public AbstractBinaryColumn instance(
      ...
      Binary[] values,
      long retainedSizeInBytes) {
    return new BlobColumn(arrayOffset, positionCount, valueIsNull, values, retainedSizeInBytes);
  }
}
