...
public class BlobColumn implements Column {
  ...
  private static final int INSTANCE_SIZE =
      (int) RamUsageEstimator.shallowSizeOfInstance(BlobColumn.class);
  ...
  public BlobColumn(int initialCapacity) {
    this(0, 0, null, new Binary[initialCapacity]);
  }

  public BlobColumn(int positionCount, Optional<boolean[]> valueIsNull, Binary[] values) {
    this(0, positionCount, valueIsNull.orElse(null), values);
  }

  BlobColumn(int arrayOffset, int positionCount, boolean[] valueIsNull, Binary[] values) {
    if (arrayOffset < 0) {
  ...
  public Column getRegionCopy(int positionOffset, int length) {
    ...
    return new BlobColumn(0, length, valueIsNullCopy, valuesCopy);
  }
  ...
  public Column subColumn(int fromIndex) {
    ...
    return new BlobColumn(arrayOffset + fromIndex, positionCount - fromIndex, valueIsNull, values);
  }
  ...
  public Column copyPositions(int[] positions, int offset, int length) {
    ...
    return new BlobColumn(0, length, newValueIsNull, newValues);
  }
